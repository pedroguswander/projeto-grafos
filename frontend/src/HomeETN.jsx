        ...
        <div className="home-hub-etn">
          <div className="hub-grid-etn">
            ...
            <div className="hub-center-wrap-etn">
              ...
              <button className="hub-card-etn hub-card-main-etn" onClick={() => onNavigate('painel')}>
            ...
            <div className="hub-col-etn">
              <button className="hub-card-etn" onClick={() => onNavigate('metricas')}>
                <span className="hub-card-title-etn">MÉTRICAS GLOBAIS</span>
                <span className="hub-card-sub-etn">Indicadores gerais</span>
              </button>

              <button className="hub-card-etn" onClick={() => onNavigate('dashboard')}>
          ...
          <div className="hub-bottom-etn">
            <button className="hub-card-etn hub-card-bottom-etn" onClick={() => onNavigate('database')}>
